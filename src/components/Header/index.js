        ...
        <div className="uk-container">
          <div className="header-wrapper">
            <div className="header-left">
              <Link to="/">
                <svg className="logo" viewBox="0 0 230 45">
                  <path
              ...
              <button className="uk-button lbc-bgcolor btn-new-ad">
                <Link to="/newad">Déposer une annonce</Link>
              </button>
            ...
            <div className="header-right">
              <ul>
                <li>
                  <Link className="uk-text-secondary" to="/signup">
                    Créer un compte
                  </Link>
                </li>
                <li>
